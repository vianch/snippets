...
- Read AGENTS.md to understand project purpose and standards
- Examine package.json for dependencies, scripts, and configuration
- Read `.Codex/memory/MEMORY.md` for persistent project context
...
- Check `.Codex/memory/session_log.md` for recent session activity
